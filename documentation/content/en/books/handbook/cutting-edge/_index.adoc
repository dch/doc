...
== Updating FreeBSD with Base System Packages (PkgBase)
...
[ `https://pkg.freebsd.org/${ABI}/kmods_latest`
...
[ `https://pkg.freebsd.org/${ABI}/kmods_latest_2`

[ releng/14.3
[ twice daily – 12:00 and 00:00 UTC
[ `https://pkg.freebsd.org/${ABI}/base_release_3`
[ `https://pkg.freebsd.org/${ABI}/kmods_latest_3`

Based on link:https://wiki.freebsd.org/PkgBase[Wiki - PkgBase]
